        ...
        <div className='ask-question'>
            <div className="ask-ques-container">
                ...
                <label htmlFor="ask-ques-title">
                    ...
                    <input type="text" id='ask-ques-title' onChange={(e)=>{setQuestionTitle(e.target.value)}} placeholder="Is there any R function to find index of an elemtn in vector?"/>
                </label>
                <label htmlFor="ask-ques-body">
                    <h4>Body</h4>
                    <p>Include all the info someone would need</p>
